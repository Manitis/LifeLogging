...
public class MyBroadcastReceiver extends BroadcastReceiver {
	...
	private void getNotificationValues() {
		...
		unfinishedCount = settings.getInt("unfinishedCount",
				0);
		xpGainIfFinished = settings.getFloat("xpGainIfFinished",
				0);
		hpLossIfUnfinished = settings.getFloat("hpLossIfUnfinished",
				0);
	}
	private void getNotificationSettings() {
		settings = PreferenceManager
				.getDefaultSharedPreferences(context);
		notificationIsEnabled = settings.getBoolean("pref_enableNotifications",
				true);
